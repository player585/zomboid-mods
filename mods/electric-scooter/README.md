...
**Version:** 1.0.0 (code complete — placeholder assets shipped)
...
**Status:** placeholder kit is now in the repo. Everything below is
auto-generated by `/.tools/gen_*.py` scripts (see `.tools/README.md`).
Replace any file with real art using the same filename — the mod will
...
### Workshop poster + icon — `42/poster.png`, `42/icon.png`, `41/poster.png`, `41/icon.png`
512×512 PNG (poster) and 128×128 PNG (icon). Shipped.
